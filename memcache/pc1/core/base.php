...
final class Base{
	...
	private static function parse_conf(&$setting_config){
		...
		$setting['shopnc_version'] = 'Copyright 2015 <a href="http://www.7in6.com" target="_blank">7in6商城</a> All rights reserved.';
	...
	private static function cp(){
		...
		if (strpos(self::CPURL,'||') !== false){
			...
			//header('location: http://www.shopjl.com');exit();
			header('location: http://www.7in6.com');exit();
		}else{
